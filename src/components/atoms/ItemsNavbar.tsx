    ...
    <>
      ...
      items.map((item: any, index: any) => {
        return (
          ...
          >
            <a href={item.href} className="text-base xl:text-base  font-medium hover:text-primary-orange hover:scale-110 transition-all flex justify-between items-center cursor-pointer" >
              <span className="mr-1">
              < item.icon  />
              </span>
              {item.name}
